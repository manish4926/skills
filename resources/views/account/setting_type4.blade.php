<div class="form-group col-md-12" style="width:98%;float:left;">
    <lable>Organisation Name <small style="color:red;">*</small></lable>
    <input name="name" required type="text" value="{{$user->name }}" placeholder="Organisation Name" class="form-control input-sm">
</div>

<div class="form-group col-md-6" style="width:45%;float:left;">
    <lable>Type of Organisation</lable>
    <?php $type_business = $user->user_profile() ? $user->user_profile()->school_category : ""; ?>
    <select name="type_business" id="type_business" class="form-control input-sm">
        <option value="">Select Type Of Business</option>
        <option <?php if($type_business=='Educational consultant'){echo 'selected';}?>>Educational consultant</option>					
        <option <?php if($type_business=='Job consultant'){echo 'selected';}?>>Job consultant</option>					
        <option <?php if($type_business=='Book wholesaler'){echo 'selected';}?>>Book wholesaler</option>					
        <option <?php if($type_business=='Book distributor'){echo 'selected';}?>>Book distributor</option>					
        <option <?php if($type_business=='Visa consultant'){echo 'selected';}?>>Visa consultant</option>	
    </select>
</div>
...
<div class="form-group col-md-6">
    ...
    <input name="p_email" id="p_email" required  type="email"  value="{{ $user->user_profile() ? $user->user_profile()->office_email : "" }}" placeholder="Office Landline" class="form-control input-sm">
</div>
