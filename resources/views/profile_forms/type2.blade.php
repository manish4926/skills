 ...
 <input name="f9" id="text_type{{$type}}_f9" type="hidden" value="">
  ...
  <div class="form-group">
      ...
      <div class="form-group">
         ...
         <label>Year of Passing <small style="color:red;">*</small></label>
       ...
       <div class="form-group">
         ...
         <label>School /College/ University <small style="color:red;">*</small></label>

         <input name="f3" id="text_type{{$type}}_f3" type="text" value="" class="form-control">
         <!--<select id="f3_opt" class="form-control">
            <option disabled="" selected="">Select University/ Collages/Schools</option>
            <option>UN1 </option>
            <option>UN2</option>
            <option>UN3</option>
            <option>Other</option>
          </select>
          <input name="f3" id="text_type{{$type}}_f3" type="text" value="" placeholder="Enter University/ Collages/Schools" class="form-control" style="display: none; margin-top: 15px;">-->
      </div>
      ...
      <div class="form-group">
         ...
         <label>Degree% <small style="color:red;">*</small></label>
...
/*$(document).ready(function(){
    $('#f3_opt').change(function(){
        if($('#f3_opt option:selected').text() == "Other"){
          $('#text_type{{$type}}_f3').val("");
          $('#text_type{{$type}}_f3').show();
        }
        else{
          $('#text_type{{$type}}_f3').hide();
          $('#text_type{{$type}}_f3').val($('#f3_opt option:selected').text());
  ...
  function editType{{$type}}(id,id2)
   ...
   function SaveType{{$type}}()
     ...
     if($("#text_type{{$type}}_f1").val() == "")
         ...
         alert("Please insert 'Qualification' text.");
          ...
          alert("Please insert 'Year of Passing' text.");
          ...
          alert("Please insert 'School /College/ University' text.");
          ...
          alert("Please insert 'Degree' text.");
