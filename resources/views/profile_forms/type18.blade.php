 ...
 <input name="f9" id="text_type{{$type}}_f9" type="hidden" value="">
  ...
  <div class="form-group">
      ...
      <div class="form-group">
         ...
         <textarea name="f2"  id="text_type{{$type}}_f2" rows=5 cols=20 class="form-control"></textarea>
       ...
       <div class="form-group">
         ...
         <input name="f3" id="text_type{{$type}}_f3" type="text" value="" class="form-control datetimepicker181">
      ...
      <div class="form-group">
         ...
         <input name="f4" id="text_type{{$type}}_f4" type="text" value="" class="form-control datetimepicker182">
